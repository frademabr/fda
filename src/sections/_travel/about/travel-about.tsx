...
export function TravelAbout({ sx, ...other }: BoxProps) {
  const renderHead = () => (
    <Box sx={{ textAlign: "center" }}>
      ...
      <Typography sx={{ mx: "auto", maxWidth: 560, color: "text.secondary" }}>
        Master Digital Filiais Strategy, Social Media Filiais, SEO, YouTube, Email,
        Facebook Filiais, Analytics & More!
      </Typography>
    </Box>
  );
  ...
  const renderLeftTexts = () => (
    <>
      ...
      <Typography sx={{ color: "text.secondary" }}>
        Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. Maecenas nec
        odio et ante tincidunt tempus. Suspendisse enim turpis, dictum sed, iaculis a,
        condimentum nec, nisi. Vestibulum eu odio. Curabitur ullamcorper ultricies nisi.
      </Typography>
    </>
  );
  ...
  return (
    ...
    >
      <Container
        sx={{ display: "flex", flexDirection: "column", gap: { xs: 5, md: 10 } }}
      >
        {renderHead()}
